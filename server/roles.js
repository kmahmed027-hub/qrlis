...
const ROLE_PERMISSIONS = {
  Admin: ["dashboard", "booking", "patient360", "reservations", "samples", "pcr", "processing", "admin", "connection"],
  Receptionist: ["dashboard", "booking", "patient360", "reservations", "samples", "connection"],
  "Lab Technician": ["dashboard", "patient360", "samples", "processing", "pcr", "connection"],
  Pathologist: ["dashboard", "patient360", "reservations", "samples", "pcr", "connection"],
};
